...
- Ground every statement in evidence: cite `path/to/file:line`. Never speculate or fabricate — if something is unconfirmed, say so and state what would confirm it.
