...
Secrets/PII are redacted (`§4`) — a handoff travels further than a register. Run `node ${CLAUDE_PLUGIN_ROOT}/scripts/co.mjs scan redaction HANDOFF.md` before handing it over — the mechanical floor under that rule.
