...
**Invoked as `/code-ops-suite:architecture`.** First read the `${CLAUDE_PLUGIN_ROOT}/CONVENTIONS.md` — operating model, quality lenses, the **documentation quality standard (`§13`)** this doc obeys, and the SSOT/freshness rules (`§12`).
