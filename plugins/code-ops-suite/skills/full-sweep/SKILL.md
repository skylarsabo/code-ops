...
**Invoked as `/code-ops-suite:full-sweep`.** Read §1, §2, §3, §4, §7, §10, §12, §13, and §14 of
...
`node ${CLAUDE_PLUGIN_ROOT}/scripts/context-query.mjs find|callers|callees|blast|explore`
