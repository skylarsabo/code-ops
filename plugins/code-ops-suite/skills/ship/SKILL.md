...
`${CLAUDE_PLUGIN_ROOT}/scripts/co.mjs scan ai-tells` over the commit and PR text directly as the
...
`node ${CLAUDE_PLUGIN_ROOT}/scripts/atlas-check.mjs check --atlas <atlas dir>`. For any section
