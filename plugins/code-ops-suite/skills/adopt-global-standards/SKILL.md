...
**Mode:** DOCUMENT · **Produces:** the user's global `~/.claude/CLAUDE.md`, written or updated
...
Resolve the global contract at `~/.claude/CLAUDE.md` and the marketplace checkout it caches.
...
action outside `~/.claude/CLAUDE.md`. Settings, hooks, permissions, and keybindings stay out of
