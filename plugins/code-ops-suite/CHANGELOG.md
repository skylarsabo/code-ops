...
- **New `scripts/preflight.mjs`** — a Phase-0 gate wired into `ship`, `debug`, `full-sweep`, and `adopt-standards` that checks environment/toolchain preconditions before a skill starts work.
