...
- **Interface consistency**: divergent implementations of the *same concept*, drifted duplication, inconsistent return/error/null conventions, contract drift across call sites.
