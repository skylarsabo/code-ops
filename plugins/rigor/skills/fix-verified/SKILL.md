...
**Invoked as `/rigor:fix-verified`.** Read only the sections named in this paragraph of
...
Run `node ${CLAUDE_PLUGIN_ROOT}/scripts/revalidate-register.mjs FINDINGS_REGISTER.md --root .`
...
`node ${CLAUDE_PLUGIN_ROOT}/scripts/revalidate-register.mjs FINDINGS_REGISTER.md --root . --consumed <pre-run copy>`,
