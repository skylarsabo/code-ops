...
## Done when
Every dependency is assessed for egress/telemetry/CVE/integrity; risky ones are flagged with concrete remediation; safe fixes verified (build/tests green).
