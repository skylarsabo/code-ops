...
**Invoked as `/privacy-opsec-suite:opsec-hardening`.** First read the bundled
...
`node ${CLAUDE_PLUGIN_ROOT}/scripts/revalidate-register.mjs LEAK_REGISTER.md --root . --consumed <pre-run copy>`,
