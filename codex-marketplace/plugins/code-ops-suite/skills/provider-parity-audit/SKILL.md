...
- **Intentionally provider-specific.** The prose is deliberately Claude-only, for example a Codex hook feature with no Codex equivalent, and documents why inline. Leave it as it stands and record the rationale.
