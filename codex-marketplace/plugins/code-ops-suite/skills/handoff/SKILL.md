...
**Invoke in Codex by naming `code-ops-suite:handoff`.** First read the `<plugin-root>/CONVENTIONS.md` bundled with this plugin — it defines the interaction protocol, safety rails, evidence standard, and shared-artifact conventions this skill extends to session state.
