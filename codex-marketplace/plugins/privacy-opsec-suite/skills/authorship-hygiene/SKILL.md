...
**Invoke in Codex by naming `privacy-opsec-suite:authorship-hygiene`.** First read the bundled `<plugin-root>/CONVENTIONS.md` — the anonymity & OpSec model (`§A`, including the tooling-trace non-negotiable), interaction protocol, safety rails, and lenses this skill follows.
