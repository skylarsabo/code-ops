...
**Invoke in Codex by naming `researcher:ecosystem-watch`.** First read the bundled `<plugin-root>/CONVENTIONS.md` — the research-integrity & egress model (§A), protocol, rails, schemas, tiers, and lenses, referenced by section.
