...
Secrets/PII are redacted (`§4`) — a handoff travels further than a register. Run `node <plugin-root>/scripts/scan-redaction.mjs HANDOFF.md` before handing it over — the mechanical floor under that rule.
