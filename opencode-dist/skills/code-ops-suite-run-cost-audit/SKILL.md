...
- `tier-routing`: judgment-bearing roles ran at the strong tier, and mech-class work sat at or above its lint-enforced floor (`AGENT_MODEL_FLOORS`, mirrored in `<plugin-root>/reference/subagent-trade-offs.md`).
