---
name: privacy-opsec-suite-full-sweep
...
**Invoked as `/privacy-opsec-suite-full-sweep`, or by the model through the `skill` tool as `privacy-opsec-suite-full-sweep`.** First read the bundled
