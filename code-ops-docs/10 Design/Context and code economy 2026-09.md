...
7. **Review lens.** A "size and boundary" lens joins the all-lens PR review table (now `rigor:deep-review` at `bar: standard`), and rule F in `normalize` is strengthened to cite the ladder.
