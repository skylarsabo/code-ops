...
| --- | --- | --- |
| `code-ops-suite` | The spine: general engineering for any repo — audit, remediation, feature discovery/build, performance, tests, dependencies, PR review, normalization, doc generators, and the orchestrators. (23 skills) | Always. This is the baseline for any project. |
